...
$totalRows_Listele = mysql_num_rows($Listele);mysql_select_db($database_uye, $uye);
$query_Listele = "SELECT id, ogrenci_adisoyadi, ogrenci_tc, ogrenci_dogumt, ogrenci_tel, ogrenci_okul, ogrenci_sinif, cinsiyet, veli_adisoyadi, veli_tc, veli_tel, veli2_adisoyadi, veli2_tel, ogrenci_seans, adres, burs, kayit_tutari, pesinat, aciklama, kayit_tarihi FROM ogrenci_bilgi";
$Listele = mysql_query($query_Listele, $uye) or die(mysql_error());
$row_Listele = mysql_fetch_assoc($Listele);
$totalRows_Listele = mysql_num_rows($Listele);
$query_Listele = "SELECT * FROM ogrenci_bilgi";
$Listele = mysql_query($query_Listele, $uye) or die(mysql_error());
$row_Listele = mysql_fetch_assoc($Listele);
$totalRows_Listele = mysql_num_rows($Listele);
?>
...
<form action="isimsonuc.php" method="get" name="form1" id="form1">
  <label for="isimara">Arama:</label>
  <input type="text" name="isimara" id="isimara">
  <input name="submit" type="submit" id="submit" formaction="isimsonuc.php" formmethod="GET" value="Ara">
</form>
<form action="sinifsonucu.php" method="get" name="form2" id="form2">
Sınıf filtrele :
  <select name="sinifara" id="sinifara" form="form2">
    <option value="8">8</option>
    <option value="7">7</option>
    <option value="6">6</option>
  </select>
  <input name="submit2" type="submit" id="submit2" formaction="sinifsonucu.php" formmethod="GET" onMouseOver="MM_effectHighlight(this, 1500, '#ffffff', '#CC6600', '#ffffff', false)" value="Getir">
</form>
<p>&nbsp;</p>
<div id="body">
  <p>&nbsp;</p>
...
?>
  <strong>Toplam kayıt sayısı : <?php echo $totalRows_Listele ?></strong>
</p>
<p>&nbsp;</p>
<p>&nbsp;</p>
</body>
