<?php require_once('Connections/uye_test.php'); ?>
<?php
if (!isset($_SESSION)) {
  session_start();
}
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form2")) {
  $insertSQL = sprintf("INSERT INTO ogrenci_bilgi (id, ogrenci_adisoyadi, ogrenci_tc, ogrenci_dogumt, ogrenci_tel, ogrenci_okul, ogrenci_sinif, cinsiyet, eposta, veli_adisoyadi, veli_tc, veli_tel, veli2_adisoyadi, veli2_tel, ogrenci_seans, adres, burs, kayit_tutari, pesinat, aciklama, kayit_tarihi) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
...
<head>
<meta charset="utf-8">
<title>Test Klubü Kayıt Ekranı</title>
<style type="text/css">
body,td,th {
	font-size: 18px;
}
...
<p align="center"><strong>TEST KLUBÜ</strong></p>
